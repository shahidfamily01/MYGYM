# Apex Fit Club — roadmap

## Done
- Cloud backend: registrations table (admin-only reads), member counter function
- Pages: Home, About, Services, Trainers, Membership, Timings, Location, Events, Reviews, Register, Contact, private Ladies portal
